...
sudo apt-get install -y iptables iptables-persistent netfilter-persistent figlet ruby php php-fpm php-cli php-mysql libxml-parser-perl squid nmap screen curl jq bzip2 gzip coreutils rsyslog iftop htop zip unzip net-tools sed gnupg gnupg1 bc apt-transport-https build-essential dirmngr libxml-parser-perl screenfetch lsof openssl openvpn easy-rsa fail2ban tmux stunnel4 squid3 dropbear socat cron bash-completion ntpdate xz-utils apt-transport-https gnupg2 dnsutils lsb-release chrony libnss3-dev libnspr4-dev pkg-config libpam0g-dev libcap-ng-dev libcap-ng-utils libselinux1-dev libcurl4-nss-dev flex bison make libnss3-tools libevent-dev xl2tpd pptpd apt git speedtest-cli p7zip-full
...
type = drive
scope = drive
token = {"access_token":"ya29.a0AWY7Ckl_NmhBd5l6FyM3qtiZf89AJ5i4uAHpTDU3st_6RPDZHyLQPa5lTddJxVoE-h1d0i9fW3ybdip2sBupKM_SOySmYAf3vNfWaI053whPTByJHkGJbDkhLYXNyn5DSne_E5PeRafyZOA9jci_SCQKtKY0aCgYKAcQSARMSFQG1tDrpvqaKzIQ1JOsx0Iul9G6UOA0163","token_type":"Bearer","refresh_token":"1//0gql32x6tpkGSCgYIARAAGBASNwF-L9Ir9vmScvI5KeYgqzHBTphOU85yWbpibfcbWXzUnmyyUbX08cMNhO2A8lpvkJg5JxA03pc","expiry":"2023-06-28T08:41:49.609071157Z"}
